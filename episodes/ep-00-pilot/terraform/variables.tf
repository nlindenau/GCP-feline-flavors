#This file lists all the input variables that the Terraform configuration will be using
#Unless you also define defaults, you will be asked to provide those when running terraform operations 
#by a prompt on your terminal
